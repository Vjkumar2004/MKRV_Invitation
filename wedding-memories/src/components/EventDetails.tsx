        ...
        <div className="max-w-4xl mx-auto rounded-[32px] bg-white shadow-soft border border-roseveil/80 px-4 sm:px-10 lg:px-16 py-10 sm:py-14 reveal-on-scroll hover-lift">
          <div className="flex flex-col items-center text-center">
            <div className="mb-8 sm:mb-10 w-52 sm:w-64 md:w-72 aspect-[3/4] rounded-t-[60%] rounded-b-[32px] overflow-hidden bg-roseveil/80 border border-roseveil shadow-soft delay-200">
              <img loading="lazy" src="/arch image.png" alt="Wedding reception" className="w-full h-full object-cover" />
            </div>
            <h1 className="font-serif text-2xl sm:text-3xl tracking-[0.03em] text-deepred-700 reveal-on-scroll reveal-heading delay-100">Wedding Reception</h1>
            ...
            <p className="mt-4 text-[11px] sm:text-xs text-deepred-700/70 font-serif italic reveal-on-scroll delay-500">
              According to Tamil Calendar
            </p>
            <div className="mt-8 flex items-center justify-center gap-7 reveal-on-scroll delay-500">
              <button type="button"
